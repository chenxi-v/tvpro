...
import DoubanCategorySelector from "@/components/DoubanCategorySelector";
...
function DoubanPageClient() {
  ...
  const handleTypeChange = useCallback((newType: string) => {
    ...
    if (newType === "movie") {
      setPrimarySelection("热门");
      setSecondarySelection("全部");
    } else if (newType === "tv" || newType === "show") {
      setPrimarySelection("最近热门");
      setSecondarySelection(newType === "tv" ? "tv" : "show");
